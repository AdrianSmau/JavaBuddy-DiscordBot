...
public class HelpCommand implements CommandInterface {
    ...
    public void handle(CommandContext ctx) {
        ...
        info.addField("`-algorithm 'fundamental_algorithm'`", "Displays an implementation of the specified algorithm", false);
        info.addField("`-algorithms`", "Displays the available algorithms and their definition (their individual implementation can be consulted with the `-algorithm` command, followed by the algorithm's name)", false);
