import Commands.Algorithm.AlgorithmCommand;
import Commands.Algorithm.AlgorithmHelperCommand;
...
public class CommandManager {
    ...
    public CommandManager() {
        addCommand(new AlgorithmCommand());
        addCommand(new AlgorithmHelperCommand());
